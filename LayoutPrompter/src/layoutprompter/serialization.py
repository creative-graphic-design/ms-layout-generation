from layoutprompter.transforms import RelationTypes
from layoutprompter.utils import CANVAS_SIZE, ID2LABEL, LAYOUT_DOMAIN
...
if __name__ == "__main__":
    ...
    from layoutprompter.utils import ID2LABEL
